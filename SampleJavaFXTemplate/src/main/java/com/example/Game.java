...
// 		Player cpu4 = new Player("cpu4", 1000);
// 		Player cpu5 = new Player("cpu5", 1000);
// 		players.put("cpu1", cpu1);
// 		players.put("cpu2", cpu2);
// 		players.put("cpu3", cpu3);
// 		players.put("cpu4", cpu4);
// 		players.put("cpu5", cpu5);
// 		amount.put("cpu1", 1000);
// 		amount.put("cpu2", 1000);
// 		amount.put("cpu3", 1000);
// 		amount.put("cpu4", 1000);
// 		amount.put("cpu5", 1000);
// 		playerList.add("cpu1");
// 		playerList.add("cpu2");
// 		playerList.add("cpu3");
// 		playerList.add("cpu4");
